 ...
 * @author Admin
 */
@WebServlet(name = "SortAscPriceOfCategoryController", urlPatterns = {"/sortascpriceofcategory"})
public class SortAscPriceOfCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Product> product = db.SortAscPriceOfCategory(cid);
