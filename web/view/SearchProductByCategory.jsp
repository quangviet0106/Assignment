        ...
        <section class="py-5">
            ...
            <div class="mb-4 ms-5">
               <h5><i class="bi bi-filter"><b></i>Lọc & Sắp xếp</b></h5>
                <div class="mt-4">
                    <form id="searchForm" action="searchproductbypriceofcategory" method="POST">
                        <b>Mức giá</b><br>
                        <input type="hidden" name="cid" value="${categorybyid.cid}">
                        <input onchange="submitForm()" type="checkbox" name="price" value="10000"/> Từ 10- 20 nghìn <br>
                        <input onchange="submitForm()" type="checkbox" name="price1" value="20000"/> Từ 20- 30 nghìn <br>
