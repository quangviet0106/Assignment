<%-- 
    ...
    Created on : Mar 8, 2022, 10:37:24 PM
    Author     : Admin
--%>
    ...
    <head>
        ...
        <script>
             function deleteOrderDetail(id)
            {
                ...
                if (result)
                {
                    window.location.href = "deleteorderdetail?id=" + id;
                }
            }
        </script>
    </head>
        ...
        <div class="container mt-5" style="min-height: 1000px">
            <div class="table-wrapper">
                <div class="table-title">
                    <h2>Những sản phẩm khách hàng đặt mua</h2>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${orderdetails}" var="o">
                            <tr>
                                ...
                                <td>${o.orderId}</td>
                                <td>
                                    <a href="#" onclick="deleteOrderDetail(${o.id});"  class="delete" data-toggle="modal">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
