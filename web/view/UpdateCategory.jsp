<%-- 
    ...
    Created on : Mar 11, 2022, 6:52:10 PM
    Author     : Admin
--%>
            ...
            <form action="updatecategory" method="POST">
                <div class="modal-body" style="width: 500px">
                    <div class="form-group">
                        <label>ID</label>
                        <input value="${categorys.cid}"name="cid" class="form-control" readonly required>
                    </div>
                    <div class="form-group">
                        <label>Name</label>
                        <input value="${categorys.cname}"name="cname" type="text" class="form-control" required>
                    </div>
                </div>
